...
<div>
 ...
 <p>
   <b>Краткое описание:</b><br>
   Бот имеет бд с возможностями поиска, записи и удаления аккаунтов, может выгружать данные в csv-файл. По типу записной книжки. Также умеет генерировать случайные пароли.<br><br>
